...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->TEMPORIZADOR,__time_to_timespec(1, 30000, 0, 0, 0, 0),retain)
  ...
  __INIT_VAR(data__->_TMP_NOT26_OUT,__BOOL_LITERAL(FALSE),retain)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->,_TMP_NOT26_OUT,,!(__GET_VAR(data__->SENSOR,)));
  __SET_VAR(data__->TP1.,IN,,__GET_VAR(data__->_TMP_NOT26_OUT,));
  __SET_VAR(data__->TP1.,PT,,__GET_VAR(data__->TIEMPO_SENSOR,));
  ...
  __SET_VAR(data__->,_TMP_NOT3_OUT,,!(__GET_VAR(data__->TOF1.Q,)));
  __SET_VAR(data__->,LED_RED,,__GET_VAR(data__->_TMP_NOT3_OUT,));
  __SET_VAR(data__->,LED_SENSOR,,__GET_VAR(data__->_TMP_NOT26_OUT,));
